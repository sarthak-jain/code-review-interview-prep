# Practice PR #1 — Booking Payment Service

**PR Title:** `feat: Add instant booking payment processing with refund support`

**Author:** dev-teammate

**Description:**
> Implements the core payment processing flow for instant bookings. When a guest books a listing, we charge their payment method immediately. Also adds refund logic for host cancellations. This is part of the new Instant Book rollout.

**Files changed:** `BookingPaymentService.java`, `PaymentController.java`

---

**Instructions:** Review this PR as you would in a real interview. Find all issues — bugs, security, performance, design, style. When you're done, tell me your findings and I'll score you.

*Tip: Aim for at least 12 issues. A senior engineer should find 15+.*
...
**When you're ready:** Tell me all the issues you found, and I'll score each one and give you your total score out of 100.
